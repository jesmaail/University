...
\section{Analysis of problem}
	...
	%Replay memory, rmsprop/backprop, q learning.
		The network will learn overall using the reinforcement learning method of Q-learning, making it a deep q-network. The backpropagation learning for the network will use a technique known as RMSProp \cite{rms}.
		\begin{algorithm}
		...
		\textbf{Explain how the Q-Learning works and how RMSProp works in theory as well as how it fits in}
