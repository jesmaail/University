...
\begin{abstract}
This is a Technical Computer Science project, which aims to develop a neural network, trained with reinforcement learning, that is able to learn to play video games. This document outlines a background the related work and theory, the management of the project itself, the technologies used, an analysis of the problem, how the problem was then implemented, and a reflection on the results as well as how it could be improved in future work.
\end{abstract}
