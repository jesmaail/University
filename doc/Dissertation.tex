	...
	The preprocessor crops the image and converts to greyscale (with use of a look-up table) using Algorithm \ref{algo:preprocess}.
		...
		\begin{algorithm}
			...
			\begin{algorithmic}[]
				...
				\State constant int ROI\textunderscore TOP = 32
				\State constant int ROI\textunderscore BOT = 18			
				\State int width = screen.width()
				\State int height = screen.height()
				\State Image img
				\State
				\State int jt = 0
